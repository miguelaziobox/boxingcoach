...
const PUNCH_SOUNDS = {
  ...
  'lead-hook':  new Audio('audio/L Hook.mp3'),
  'rear-hook':  new Audio('audio/R Hook.mp3'),
  'lead-upper': new Audio('audio/L Upper.mp3'),
  'rear-upper': new Audio('audio/R Upper.mp3'),
  'body-jab':       new Audio('audio/Body Jab.mp3'),
  'body-cross':     new Audio('audio/Body Cross.mp3'),
  'body-lead-hook': new Audio('audio/Body Lead Hook.mp3'),
  'body-rear-hook': new Audio('audio/Body Rear Hook.mp3'),
